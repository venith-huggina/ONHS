...
<head>
  ...
  <title>Online Nurse Hospital System | Manage Nurse</title>
...
?>
                  ...
                  <tr>
                   ...
                   <td><?php echo $result['Email']?></td>
                    ...
                    <th>
     <a href="edit-nurse.php?editid=<?php echo $result['ID'];?>" title="Edit Nurse Details"> <i class="fa fa-edit" aria-hidden="true"></i> </a> | 
     <a href="manage-nurse.php?action=delete&&bsid=<?php echo $result['ID']; ?>&&profilepic=<?php echo $result['ProfilePic'];?>" style="color:red;" title="Delete this record" onclick="return confirm('Do you really want to delete this record?');"><i class="fa fa-trash" aria-hidden="true"></i> </a>
 </th>
                  </tr>
         <?php $cnt++;} ?>
