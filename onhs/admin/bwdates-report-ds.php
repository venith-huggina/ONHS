...
<head>
  ...
  <title>Online Nurse Hospital System | Between Dates Report Date Selection</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">B/w Dates Report Date Selection</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">B/w Date Report Date Selection</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
